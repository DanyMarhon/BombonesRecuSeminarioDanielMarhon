        ...
        public static void SetearFila(DataGridViewRow r, object obj)
        {
            switch (obj)
            {
                ...
                case BombonListDto bombon:
                    ...
                    break;
                case Envio envio:
                    r.Cells[0].Value = envio.EnvioId;
                    r.Cells[1].Value = envio.Cobertura;
                    r.Cells[2].Value = envio.Nombre;
                    r.Cells[3].Value = envio.EnviosAereos;
                    r.Cells[4].Value = envio.Direccion;
                    r.Cells[5].Value = envio.CiudadId;
                    r.Cells[6].Value = envio.ProvinciaEstadoID;
                    r.Cells[7].Value = envio.PaisID;
                    break;
