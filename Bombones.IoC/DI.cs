...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioEnvios, RepositorioEnvios>();
            ...
            service.AddScoped<IServiciosEnvios>(sp => {
                var repositorio = new RepositorioEnvios();
                return new ServiciosEnvios(repositorio, cadena);
            });
